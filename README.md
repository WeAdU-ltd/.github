...
- **Inventaires cloud** (régénérables par script, secrets hors repo) :
  ...
  - [Chief of Staff (COS) — Replit / EC2 / Git (WEA-49)](docs/inventory/cos-replit-ec2-migration-2026-05-04.md) — repo applicatif [`WeAdU-ltd/cos`](https://github.com/WeAdU-ltd/cos) ; import code à faire ; lien [WEA-29](docs/inventory/WEA-29-aws-ec2-inventory.md)
