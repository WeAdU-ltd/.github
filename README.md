...
- **Inventaires cloud** (régénérables par script, secrets hors repo) :
  ...
  - [Waste Watcher — Repl 8 / synthèse inventaire (WEA-87)](docs/inventory/waste-watcher-replit-synthesis-WEA-87.md) — consolidation fil Linear + consigne export Repl ; [WEA-33](docs/inventory/WEA-33-replit-inventory.md) ligne **#8**
