...
| 17 | Feed Optimizer | `cb7bc686-…` | pas de `.replit.app` actif (export **2026-05-12**) ; prod cible **EC2** Windows eu-west-2 (NSSM **FeedOptimizer**) — **pas d’IP** dans ce tableau ([WEA-29](./WEA-29-aws-ec2-inventory.md)) | **Partiel** | [`JeffWeadu/feed-optimizer`](https://github.com/JeffWeadu/feed-optimizer) — privé ; backup Replit `gitsafe` | **Non** (pas KV Replit) ; **SQLite** locale `data/shopping_optimizer.db` (gitignored) | **Non** (export 2026-05-12) | `OP_SERVICE_ACCOUNT_TOKEN` (Replit) + **1Password** (`op://`) — noms : voir [`feed-optimizer-replit-export-2026-05-12.md`](./feed-optimizer-replit-export-2026-05-12.md) | **Oui** — EC2 Windows (détail hors IP ici) | **P3** | Société — **écart** : code sur compte **perso** ; alignement `WeAdU-ltd` → **WEA-142** | Chaîne [WEA-139](https://linear.app/weadu/issue/WEA-139) ; export [`feed-optimizer-replit-export-2026-05-12.md`](./feed-optimizer-replit-export-2026-05-12.md) ; runbook [`feed-optimizer-replit-migration-WEA-139.md`](./feed-optimizer-replit-migration-WEA-139.md) |
...
_Document vivant ; dernière intégration dépôt : données Socle 2026-03-29 ; alignement chaîne Linear 2026-05-05 (Repl #11 hors migration) ; couverture Socle vs Team Replit : **2026-05** ; pd-detection ligne **#15**, Git équivalent, runbook et export Repl : **2026-05-12** (WEA-128 / WEA-129 / WEA-130) ; Feed Optimizer ligne **#17**, export agent Repl : **2026-05-12** ([WEA-139](https://linear.app/weadu/issue/WEA-139))._
