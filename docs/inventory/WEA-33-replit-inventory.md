...
| 7 | Max Conv Val Budget Mngt | `d32b27a6-…` | absent CSV 2026-03-17 | **Partiel** | [`WeAdU-ltd/max-conv-val-budget-mngt`](https://github.com/WeAdU-ltd/max-conv-val-budget-mngt) — **créé** (**2026-05-12**), squelette ; code métier **non importé** | inconnu | inconnu | probable Google Ads + kit | inconnu | **P2** | Société | Chaîne [WEA-79](https://linear.app/weadu/issue/WEA-79) ; runbook [`max-conv-val-budget-mngt-replit-migration-WEA-79.md`](./max-conv-val-budget-mngt-replit-migration-WEA-79.md) ; synthèse Socle [`max-conv-val-budget-mngt-replit-synthese-socle-2026-05-12.md`](./max-conv-val-budget-mngt-replit-synthese-socle-2026-05-12.md) |
...
_Document vivant ; dernière intégration dépôt : données Socle 2026-03-29 ; alignement chaîne Linear 2026-05-05 (Repl #11 hors migration) ; couverture Socle vs Team Replit : **2026-05** ; pd-detection ligne **#15**, Git équivalent, runbook et export Repl : **2026-05-12** (WEA-128 / WEA-129 / WEA-130) ; Repl **#7** — chaîne [WEA-79](https://linear.app/weadu/issue/WEA-79), runbook, dépôt GitHub squelette + synthèse Socle : **2026-05-12**._
