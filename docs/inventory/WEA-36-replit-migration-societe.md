...
| **3 — after-framfield-cockpit** | Repo perso **`JeffWeadu/after-framfield-cockpit`** **créé** (2026-05-05). OAuth workspace encore éphémère jusqu’à cutover ; code à pousser depuis Repl. | Premier push + README dans le repo perso ; OAuth stable ([WEA-20](../GOOGLE_OAUTH_WEA20.md)) ; puis retirer la ligne ([WEA-38](https://linear.app/weadu/issue/WEA-38/replit-fermeture-apres-bascule-complete)). |
