...
| **7 — Max Conv Val Budget Mngt** | Chaîne migration ouverte ([WEA-79](https://linear.app/weadu/issue/WEA-79)) ; pas d’export agent versionné dans ce dépôt à ce jour — runbook [`max-conv-val-budget-mngt-replit-migration-WEA-79.md`](./max-conv-val-budget-mngt-replit-migration-WEA-79.md). | Exécuter [WEA-80](https://linear.app/weadu/issue/WEA-80) → [WEA-84](https://linear.app/weadu/issue/WEA-84) ; retirer la ligne après cutover ou justifier résiduel. |
...
_Document vivant ; première intégration dépôt : 2026-05-04 ; ligne résiduelle Repl **#7** + runbook : **2026-05-12**._
