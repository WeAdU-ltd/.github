...
| **P1** | 5 | wellbots-shopping-ads-checker | `WeAdU-ltd/SH-Checker-Bids` | README + CI ; **prod documentée** : GitHub Actions → **EC2 Windows** (`deploy.yml`) — [validation runbook Repl #5](./wellbots-shopping-ads-checker-replit-migration-2026-05-06.md) §5. |
...
3. **P1** : **Negative-Terms** — prod validée sur **AWS** ([runbook Repl #4](./negative-search-terms-replit-migration-2026-05-06.md) §5) ; résiduel Replit optionnel (staging/E2E doc). **SH-Checker-Bids** — **cutover prod** documenté (**GitHub → EC2**, pas Replit comme canal — [runbook Repl #5](./wellbots-shopping-ads-checker-replit-migration-2026-05-06.md) §5) ; résiduel : fermeture Repl / secrets ([WEA-38](https://linear.app/weadu/issue/WEA-38/replit-fermeture-apres-bascule-complete)). Vision **moyen terme** : outillage **NEG + SH-Checker** articulé (voir §6 des runbooks Repl #4 / #5). **after-framfield-cockpit** → fait ([runbook](./after-framfield-cockpit-replit-2026-05-05.md)).
...
| **5 — wellbots-shopping-ads-checker** | **Dépôt** [`WeAdU-ltd/SH-Checker-Bids`](https://github.com/WeAdU-ltd/SH-Checker-Bids) **confirmé**. **Prod** livrée depuis **GitHub** vers **EC2 Windows** (workflow [`deploy.yml`](https://github.com/WeAdU-ltd/SH-Checker-Bids/blob/main/.github/workflows/deploy.yml)), pas via Replit — [validation](./wellbots-shopping-ads-checker-replit-migration-2026-05-06.md) §5 ; chaîne [WEA-67](https://linear.app/weadu/issue/WEA-67/repl-5-wellbots-shopping-ads-checker-migration-replit-github-societe). **Résiduel** : Repl / secrets Replit tant que non fermés. | Fermer le Repl et retirer les références Replit dans **SH-Checker-Bids** si besoin ; puis retirer cette ligne ([WEA-38](https://linear.app/weadu/issue/WEA-38/replit-fermeture-apres-bascule-complete)). |
