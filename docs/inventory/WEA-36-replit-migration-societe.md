...
| **7 — Max Conv Val Budget Mngt** | Chaîne [WEA-79](https://linear.app/weadu/issue/WEA-79) ; dépôt **[`WeAdU-ltd/max-conv-val-budget-mngt`](https://github.com/WeAdU-ltd/max-conv-val-budget-mngt)** ; export ingéré [`max-conv-val-budget-mngt-replit-export-2026-05-12.md`](./max-conv-val-budget-mngt-replit-export-2026-05-12.md) ; **push applicatif** depuis workspace **Feed Optimizer** (#17) **2026-05-13** ; prod Lambda décrite dans l’export ; cutover Replit vs charge : **WEA-84**. | Aligner runbook [WEA-79](./max-conv-val-budget-mngt-replit-migration-WEA-79.md) avec l’état `main` ; clôturer **WEA-83** / **WEA-84** selon critères ; retirer la ligne ou justifier résiduel. |
...
_Document vivant ; première intégration dépôt : 2026-05-04 ; ligne résiduelle Repl **#7** : runbook + dépôt squelette **2026-05-12**._
