...
| **7 — Max Conv Val Budget Mngt** | Chaîne [WEA-79](https://linear.app/weadu/issue/WEA-79) ; dépôt **[`WeAdU-ltd/max-conv-val-budget-mngt`](https://github.com/WeAdU-ltd/max-conv-val-budget-mngt)** (squelette **2026-05-12**) ; **pas** d’export agent Repl dans ce dépôt — runbook [`max-conv-val-budget-mngt-replit-migration-WEA-79.md`](./max-conv-val-budget-mngt-replit-migration-WEA-79.md). | [WEA-80](https://linear.app/weadu/issue/WEA-80) (export) puis import code + cutover [WEA-84](https://linear.app/weadu/issue/WEA-84) ; retirer la ligne ou justifier résiduel. |
