...
3. **P1** : **en cours** — pousser le code **negative-search-terms-tool** → [`WeAdU-ltd/Negative-Terms`](https://github.com/WeAdU-ltd/Negative-Terms) et **wellbots-shopping-ads-checker** → [`WeAdU-ltd/SH-Checker-Bids`](https://github.com/WeAdU-ltd/SH-Checker-Bids) depuis les Repls ([runbooks](./negative-search-terms-replit-migration-2026-05-06.md) / [runbook SH](./wellbots-shopping-ads-checker-replit-migration-2026-05-06.md)) ; **after-framfield-cockpit** → fait ([runbook](./after-framfield-cockpit-replit-2026-05-05.md)).
...
| **4 — negative-search-terms-tool** | **Dépôt cible** [`WeAdU-ltd/Negative-Terms`](https://github.com/WeAdU-ltd/Negative-Terms) **confirmé** ; code / cutover encore à finaliser depuis le Repl — [runbook](./negative-search-terms-replit-migration-2026-05-06.md) ; chaîne [WEA-61](https://linear.app/weadu/issue/WEA-61/repl-4-negative-search-terms-tool-migration-replit-github-societe). | Pousser le code depuis le Repl ; README + CI ; désactiver / supprimer le Repl ; retirer cette ligne ([WEA-38](https://linear.app/weadu/issue/WEA-38/replit-fermeture-apres-bascule-complete)). |
