...
| **P1** | 3 | after-framfield-cockpit | **Bloqué** arbitrage Perso / Société — pas d’URL GitHub tant que non tranché ([runbook](./after-framfield-cockpit-replit-2026-05-05.md)) | Après arbitrage : README du dépôt + redirect OAuth selon [WEA-20](../GOOGLE_OAUTH_WEA20.md). |
...
| **3 — after-framfield-cockpit** | **Décision Perso / Société** et dépôt GitHub **non fixés** ; OAuth workspace éphémère ([WEA-33](./WEA-33-replit-inventory.md) #3). Documentation : [`after-framfield-cockpit-replit-2026-05-05.md`](./after-framfield-cockpit-replit-2026-05-05.md). | Trancher sur ticket [WEA-55](https://linear.app/weadu/issue/WEA-55/repl-3-after-framfield-cockpit-migration-replit-github-persosociete-a-trancher) ; puis créer ou pointer le repo ; stabiliser redirect OAuth ([WEA-20](../GOOGLE_OAUTH_WEA20.md)) ; cutover hors Repl. |
