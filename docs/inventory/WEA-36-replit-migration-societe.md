...
| **RH / iso** | 15 | pd-detection | **à confirmer** — périmètre [WEA-37](https://linear.app/weadu/issue/WEA-37/replit-migration-repos-perso-isolation-acces) / secrets isolés | Documenter run + isolation Finance-RH selon [WEA-13](./WEA-13-github-access-model.md). Runbook [pd-detection](./pd-detection-replit-migration-WEA-128.md) — [WEA-128](https://linear.app/weadu/issue/WEA-128/pd-detection-brief-agent-replit-infos-migration), [WEA-129](https://linear.app/weadu/issue/WEA-129/pd-detection-synthese-inventaire-ticket-a-jour), dépôt [WEA-130](https://linear.app/weadu/issue/WEA-130). |
