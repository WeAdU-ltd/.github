...
| **5 — wellbots-shopping-ads-checker** | **Prod** livrée depuis **GitHub** vers **EC2 Windows** (workflow [`deploy.yml`](https://github.com/WeAdU-ltd/SH-Checker-Bids/blob/main/.github/workflows/deploy.yml)), pas via Replit — [validation](./wellbots-shopping-ads-checker-replit-migration-2026-05-06.md) §5 ; chaîne [WEA-67](https://linear.app/weadu/issue/WEA-67/repl-5-wellbots-shopping-ads-checker-migration-replit-github-societe). **Résiduel** : Repl / secrets Replit tant que non fermés — comme ligne #4. | Fermer le Repl et retirer les références Replit dans **SH-Checker-Bids** si besoin ; puis retirer cette ligne ([WEA-38](https://linear.app/weadu/issue/WEA-38/replit-fermeture-apres-bascule-complete)). |
