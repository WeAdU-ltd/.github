...
| **3 — after-framfield-cockpit** | **Code + README** sur GitHub privé **`JeffWeadu/after-framfield-cockpit`** ; **Repl** encore possible pour dev tant que **OAuth** peut pointer vers un hostname workspace **éphémère**. | Stabiliser les redirects ([WEA-20](../GOOGLE_OAUTH_WEA20.md)) ; fermer le Repl ; révoquer secrets Replit ; retirer cette ligne ([WEA-38](https://linear.app/weadu/issue/WEA-38/replit-fermeture-apres-bascule-complete)). |
