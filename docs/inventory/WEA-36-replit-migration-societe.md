...
**Repl #6 — WeAdU LeadGen.** Chaîne Linear parent [WEA-73](https://linear.app/weadu/issue/WEA-73/repl-6-weadu-leadgen-migration-replit-github-societe) avec sous-tickets ordonnés **WEA-74** → **WEA-78** (relations `blocks` alignées sur le modèle §2.1). Runbook dépôt : [`weadu-leadgen-replit-migration-2026-05-12.md`](./weadu-leadgen-replit-migration-2026-05-12.md).

**Repl #7 — Max Conv Val Budget Mngt.** Dépôt org **[`WeAdU-ltd/max-conv-val-budget-mngt`](https://github.com/WeAdU-ltd/max-conv-val-budget-mngt)** ; chaîne [WEA-79](https://linear.app/weadu/issue/WEA-79) ; cutover documenté **[WEA-84](https://linear.app/weadu/issue/WEA-84/max-conv-val-budget-mngt-cutover-hors-replit-ou-classement-residuel-justifie)** — [runbook](./max-conv-val-budget-mngt-replit-migration-WEA-79.md).

**Repl #8 — Waste Watcher (*Waste Controller*).** Dépôt org cible **[`WeAdU-ltd/waste-watcher`](https://github.com/WeAdU-ltd/waste-watcher)** — [WEA-88](https://linear.app/weadu/issue/WEA-88/waste-watcher-depot-github-wead-u-ltd-cree-ou-confirme) ; export + synthèse [WEA-87](https://linear.app/weadu/issue/WEA-87) ; [runbook](./waste-watcher-replit-migration-WEA-88.md). Bootstrap : [`waste_watcher_repo_wea88.py`](../../scripts/waste_watcher_repo_wea88.py) / workflow `waste-watcher-repo-wea88.yml`. WEA-89 : README + CI préparés dans le bootstrap, code importé encore bloqué tant que le dépôt cible n'est pas résolvable et que les sources Replit ne sont pas disponibles dans `.github` ([runbook WEA-89](./waste-watcher-code-readme-ci-WEA-89.md)).

**Note — Repl #17 (Feed Optimizer).** Export **2026-05-12** [`feed-optimizer-replit-export-2026-05-12.md`](./feed-optimizer-replit-export-2026-05-12.md) ; passation **2026-05-13** [`feed-optimizer-replit-passation-2026-05-13.md`](./feed-optimizer-replit-passation-2026-05-13.md). Dépôts : workspace [`JeffWeadu/feed-optimizer`](https://github.com/JeffWeadu/feed-optimizer) ; org [`WeAdU-ltd/max-conv-val-budget-mngt`](https://github.com/WeAdU-ltd/max-conv-val-budget-mngt) (push **Trees API**). Chaîne [WEA-139](https://linear.app/weadu/issue/WEA-139/repl-17-feed-optimizer-migration-replit-github-societe) ; runbook [`feed-optimizer-replit-migration-WEA-139.md`](./feed-optimizer-replit-migration-WEA-139.md). **Repl #7** : cutover prod budget documenté **[WEA-84](https://linear.app/weadu/issue/WEA-84/max-conv-val-budget-mngt-cutover-hors-replit-ou-classement-residuel-justifie)** ; aligner tickets [WEA-79](https://linear.app/weadu/issue/WEA-79) / [WEA-83](https://linear.app/weadu/issue/WEA-83) sur le dépôt org si besoin ; lien inventaire **#7** vs **#17**.
...
| **17 — Feed Optimizer** | Code sur GitHub ([`JeffWeadu/feed-optimizer`](https://github.com/JeffWeadu/feed-optimizer), [`WeAdU-ltd/max-conv-val-budget-mngt`](https://github.com/WeAdU-ltd/max-conv-val-budget-mngt)) ; **pas d’usage courant** ; complétion prod **reportée au besoin** (décision opérateur **2026-05-13** — [runbook](./feed-optimizer-replit-migration-WEA-139.md) § décision). Repl encore porteur de secrets bootstrap / heartbeat Socle tant que non traités. | Clôturer [WEA-144](https://linear.app/weadu/issue/WEA-144) en **résiduel justifié** ou cutover ; rotation secrets Replit-only ; heartbeat / Socle ; puis fermeture Repl ([WEA-38](https://linear.app/weadu/issue/WEA-38/replit-fermeture-apres-bascule-complete)). |
...
**Historique — Repl #7 (Max Conv Val Budget Mngt / Wellbots budget).** Cutover documenté sur **[WEA-84](https://linear.app/weadu/issue/WEA-84/max-conv-val-budget-mngt-cutover-hors-replit-ou-classement-residuel-justifie)** (**2026-05-13**) : la **production** du script budget (ajustements Google Ads planifiés) est sur **AWS Lambda** `wellbots-budget-lambda-prod` avec déclencheur **EventBridge** et secrets **SSM** `/wellbots/prod/*` — voir [export Repl](./max-conv-val-budget-mngt-replit-export-2026-05-12.md) §6 ; la **FastAPI Replit** y est indiquée **non déployée en production** (dev / orchestration uniquement). Code source : dépôt **[`WeAdU-ltd/max-conv-val-budget-mngt`](https://github.com/WeAdU-ltd/max-conv-val-budget-mngt)** (`main`, push applicatif **2026-05-13** depuis le workspace Feed Optimizer — [`feed-optimizer-replit-passation-2026-05-13.md`](./feed-optimizer-replit-passation-2026-05-13.md)). Runbook chaîne : [`max-conv-val-budget-mngt-replit-migration-WEA-79.md`](./max-conv-val-budget-mngt-replit-migration-WEA-79.md). Suite **optionnelle** : fermeture du Repl Replit et rotation du secret bootstrap `OP_SERVICE_ACCOUNT_TOKEN` côté Repl quand le poste n’est plus utilisé ([WEA-38](https://linear.app/weadu/issue/WEA-38/replit-fermeture-apres-bascule-complete)).
...
_Document vivant ; première intégration dépôt : 2026-05-04 ; Repl **#7** : résiduel §5 retiré après cutover documenté **2026-05-13** ([WEA-84](https://linear.app/weadu/issue/WEA-84/max-conv-val-budget-mngt-cutover-hors-replit-ou-classement-residuel-justifie))._
