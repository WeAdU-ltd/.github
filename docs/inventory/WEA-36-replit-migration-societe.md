...
3. **P1** : basculer **negative-search-terms-tool** et **wellbots-shopping-ads-checker** vers les dépôts connus ; **after-framfield-cockpit** → [`JeffWeadu/after-framfield-cockpit`](https://github.com/JeffWeadu/after-framfield-cockpit) (**Repl supprimé**, **2026-05-05** — [runbook](./after-framfield-cockpit-replit-2026-05-05.md)).
