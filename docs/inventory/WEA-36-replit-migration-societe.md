...
| **15 — pd-detection** | Cutover ouvert ([WEA-132](https://linear.app/weadu/issue/WEA-132)) ; gabarit `.github` prêt ([WEA-131](https://linear.app/weadu/issue/WEA-131)). | Overlay gabarit dans [`JeffWeadu/pd-detection`](https://github.com/JeffWeadu/pd-detection) ; ingérer [runbook §2](./pd-detection-replit-migration-WEA-128.md) ; basculer prod hors `.replit.app` ; clôturer [WEA-132](https://linear.app/weadu/issue/WEA-132). |
