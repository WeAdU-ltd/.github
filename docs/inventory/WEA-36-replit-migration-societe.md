...
| **2 — Chief of Staff Virtuel IA (COS)** | **Prod** sur **AWS / instance Windows** (`leadgen.generads.com`) — voir [WEA-33](./WEA-33-replit-inventory.md) #2 et [`cos-replit-ec2-migration-2026-05-04.md`](./cos-replit-ec2-migration-2026-05-04.md). **Dépôt applicatif** : **`https://github.com/WeAdU-ltd/cos`** — **code importé sur `main`** (**2026-05-08**). Le **Repl COS** peut encore exister en dev / archive. | **README** / **CI** dans **`cos`** si besoin ; **fermer** ou vider le Repl quand plus utile ; puis retirer cette ligne ([WEA-38](https://linear.app/weadu/issue/WEA-38/replit-fermeture-apres-bascule-complete)). |
...
**Note — COS (infra).** L’**accès agents / GitHub Actions** à l’hôte Windows via **SSM** (OIDC, **`mi-08ba03ce367298b11`**) est documenté dans [`cos-replit-ec2-migration-2026-05-04.md`](./cos-replit-ec2-migration-2026-05-04.md) §2.1 et [`AWS_GITHUB_OIDC_SSM.md`](../AWS_GITHUB_OIDC_SSM.md). Le dépôt **`WeAdU-ltd/cos`** contient le **code importé** ; la ligne **#2** reste tant que le **Repl** n’est pas fermé ou tant que **README/CI** dans **`cos`** ne sont pas stabilisés au sens [WEA-38](https://linear.app/weadu/issue/WEA-38/replit-fermeture-apres-bascule-complete).
