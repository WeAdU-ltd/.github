...
| **n8n** (Cloud ou self-hosted) | URL de base, clé API, auth éventuelle | Conventions et checklist [WEA-26](https://linear.app/weadu/issue/WEA-26/n8n-hebergement-20-euromois-cloud-vs-vps-mise-en-service) : [`WEA-26-n8n-hebergement.md`](./WEA-26-n8n-hebergement.md). |
