...
| **Brave Search API** | Clé API recherche web (`X-Subscription-Token`) | Doc [`BRAVE_SEARCH_API_WEA22.md`](./BRAVE_SEARCH_API_WEA22.md), ticket [WEA-22](https://linear.app/weadu/issue/WEA-22/brave-search-api-cles-et-quotas-pour-agents) ; variables **`BRAVE_SEARCH_API_KEY`** ou **`Brave_API`** (1Password, GitHub, Cursor). |
