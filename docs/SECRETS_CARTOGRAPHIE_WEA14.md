...
| **n8n** (Cloud ou self-hosted) | URL de base, clé API, auth éventuelle | Conventions et checklist [WEA-26](https://linear.app/weadu/issue/WEA-26/n8n-hebergement-20-euromois-cloud-vs-vps-mise-en-service) : [`WEA-26-n8n-hebergement.md`](./WEA-26-n8n-hebergement.md). Politique d’envoi humain (UK) et lien [WEA-31](https://linear.app/weadu/issue/WEA-31/n8n-files-e-mail-humain-etalement-5h-23h-uk-integrations) : [`NOTIFICATIONS_EMAIL_SLACK_WEA19.md`](./NOTIFICATIONS_EMAIL_SLACK_WEA19.md). |
